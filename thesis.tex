...
% * urls and technologies in footnotes no ending slash (/)
% * bibliography and citations (et~al.)
% * single terms in capitals (deployment,developers/engineers, slack, kubernetes)
% * important terms in italics (deployer, nonfunctional production regression testing, gemupdater)
% * abkürzungen alle groß
% * capitals for captions of tables and figures (without .)
% * glossar
% * put in some of the old evaluation
% * abstract + summary
...
\include{pieces/main}
\glsaddall % add all terms to glossary
