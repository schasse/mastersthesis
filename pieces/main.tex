...
dependencies. Operation teams were responsible for maintaining those installed
...
run in Kubernetes and to deploy itself. The chapter explained \deployer's http
