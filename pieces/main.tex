...
The last experiment aims at the feasibility and a first assessment of a metric comparison
and the time of a broken canary being in production. DIN provided one hour of production
traffic of their website, which a
...
The qualitative feedback in the lessons learned section comes mainly from use of
nonfunctional production regression testing for the GapFish rails application in
production.
