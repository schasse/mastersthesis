...
\myemph{Non-functional} refers to the \myemph{change}, which the monitoring system
monitors. Usually maintenance changes are non-functional changes, for instance performance
improvements or security updates. \myemph{Production} refers to the \myemph{environment}, in
which the versions are monitored. The production traffic reaches the new version as well
as the stable version. The term \myemph{regression} refers to the \myemph{testing}
strategy. The monitoring system tests the metrics of the stable version and the new
version for a regression.
