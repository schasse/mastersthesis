...
\begin{description}
    \item [(1)] push new version
    \item [(2)] inform about new version
    \item [(3)] fetch code
    \item [(4)] build
    \item [(5)] push container image(s)
    \item [(6)] run tests
    \item [(7)] deploy message
    \item [(8)] fetch code
    \item [(9)] modify resource definitions
    \item [(10)] apply to production cluster
    \item [(11)] pull container image(s)
    \item [(12)] send metrics
    \item [(13)] trigger full rollout or rollback
\end{description}
...
statefulsets and so on. These resource defintions should be stored in the 'kubernetes'
