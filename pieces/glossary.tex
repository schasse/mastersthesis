...
\newglossaryentry{g:microservices}{
  name=microservices,
  description={is a software architecture, in which several small services
...
\newglossaryentry{g:cdep}{
  ...
  description={is an extension to continuous delivery. An automated deploy process
...
\newglossaryentry{g:pod}{
  name=Pod,
  description={is a Kubernetes resource. A Pod consists out of multiple containers
    which are located on the same host to be able to share resources~\cite{pod}}
}
\newglossaryentry{g:service}{
  name=Service,
  description={is a Kubernetes resource which basically acts as a load balancer
...
\newglossaryentry{g:rolling}{
  ...
  One instance will be created in the new version, therefore an instance of the old version
  will be shut down. The mechanism proceeds until every instance is in the new version}
}
\newglossaryentry{g:registry}{
  name=container image registry,
  description={is a repository which stores container images.}
}
